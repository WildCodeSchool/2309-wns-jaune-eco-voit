...
export const journeysData: Omit<JourneyEntity, 'user'>[] = [
    {
        departureTime: new Date('2025-10-07T14:48:00.000Z'),
        availableSeats: 1,
        automaticAccept: false,
        arrivalTime: new Date('2025-10-07T19:48:00.000Z'),
    ...
    {
        departureTime: new Date('2025-10-05T14:48:00.000Z'),
        availableSeats: 1,
        automaticAccept: true,
        arrivalTime: new Date('2025-10-05T23:48:00.000Z'),
        createdAt: new Date('2024-03-12T13:46:48.144Z'),
