...
// import { UPDATE_USER } from './utils/requetes/mutations/user.mutations'
...
//     // jest.spyOn(initialDatasource, 'getRepository')
//     //     .mockReturnValueOnce(datasource.getRepository(UserEntity))
...
//     it('should create a booking and have status accepted when automatic accept on journey is true and decrease journey available seat', async () => {
